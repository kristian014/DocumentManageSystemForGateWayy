namespace DocumentManageSystemForGateWay.Migrations
{
    ...
    public partial class database : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        SelectedStartDate = c.DateTime(nullable: false),
                        SelectedEndDate = c.DateTime(nullable: false),
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.FileUploads", "Document_DocumentID", "dbo.Documents");
            ...
            DropIndex("dbo.FileUploads", new[] { "Document_DocumentID" });
